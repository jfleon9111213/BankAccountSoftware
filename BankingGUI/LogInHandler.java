...
public class LogInHandler extends BaseHandler{
    ...
    private void createButtons() {
       ...
       sign.setOnAction(event -> {
           ...
           if(emptyFields()) {
                Alert emptyField = new Alert(Alert.AlertType.ERROR, "Field was not fully filled out.");
                emptyField.setHeaderText("Log in failed.");
                emptyField.show();
           }
           else if(true) {//login correct
               this.handleStage(primaryStage, 2);
           }
           else {
               Alert loginFail = new Alert(AlertType.ERROR, "Make sure you enterd your information correctly");
    ...
    private boolean emptyFields() {
        return textUser.getText().isEmpty() || textPassword.getText().isEmpty() || textPin.getText().isEmpty();
    }
}
